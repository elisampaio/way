  ...
  if (localStorage.getItem("records") == null) {
    ...
    records.forEach(function (record) {
      let newRecord = $(`<div class="newRecord">
        ...
        <p><img src="icons/2.png" class="icons"><span>${record.feel}</span></p>
        <p><img src="icons/3.png" class="icons"><span>${record.sleep}</span></p>
        <p><img src="icons/4.png" class="icons"><span>${record.exercise}</span></p>
